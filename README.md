# anime.jsドキュメント翻訳
[anime.js](http://animejs.com/)は、軽量なアニメーションライブラリです。  
ちょっとしたアニメーションを簡単に導入することができますし、  
工夫すれば凝ったアニメーションも作成できます。  

ここではanime.js公式サイトのドキュメントを日本語に翻訳・改変してまとめています。  
定期的に更新しますが、情報が古かったり、間違った内容が書かれている可能性があります。

最新の情報は[公式サイト](http://animejs.com/documentation/)をご確認ください。
